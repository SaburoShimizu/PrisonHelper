...
{FF7000}/привет{d5dedd} - Спросить что нужно зеку
{FF7000}/куф{d5dedd} - Нацепить на зека наручники через решётку
{FF7000}/ункуф{d5dedd} - Снять наручники с человека через решётку
{FF7000}/кпз{d5dedd} - Сказать зеку о карцере
{FF7000}/кпз-врем{d5dedd} - Сказать зеку о карцере
{FF7000}/варн{d5dedd} - Предупреждение о карцере
{FF7000}/нарушение{d5dedd} - РП диалог + РП дубинка
...
{FF7000}/стол{d5dedd} - Приказ зеку слезть со стола
{FF7000}/режим{d5dedd} - Лекции для зеков
